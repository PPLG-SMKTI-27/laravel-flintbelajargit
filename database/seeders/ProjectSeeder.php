    ...
    public function run()
    {
        ...
        $projects = [
            ...
            [
                ...
                'technologies' => ['Laravel', 'Vue.js', 'Pusher', 'PostgreSQL', 'Management Tool'],
                'demo_url' => '#',
                'source_url' => '#',
            ],
            [
                ...
                'image' => 'https://images.unsplash.com/photo-1554284126-3e4e7d8f3f0f?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1770&q=80',
                'technologies' => ['React Native', 'Laravel API', 'Firebase', 'HealthKit'],
                'demo_url' => '#',
                'source_url' => '#',
            ]
        ];
